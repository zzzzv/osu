...
namespace osu.Game.EzOsuGame.Scoring
{
    ...
    {
        None,
        // TODO(EZ-SR-TL-019): blocked: Osu Session 架构就绪后改为 OsuSession 并删除 HitEvents 枚举名。
        HitEvents,
        ManiaSession,
    }
    ...
    public static class EzScoreRaceRulesetSupport
    {
        ...
        public static EzScoreRaceGhostTimelineMode GetGhostTimelineMode(RulesetInfo? ruleset)
        {
            ...
            switch (ruleset.OnlineID)
            {
                ...
                case 0:
                    // TODO(EZ-SR-TL-006): blocked: Osu Session 架构就绪后返回 OsuSession + RunTimelineDirectAsync。
