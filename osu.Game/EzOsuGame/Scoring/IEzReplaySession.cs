...
namespace osu.Game.EzOsuGame.Scoring
{
    ...
    /// <para>environment 为 null 时由 Session 按 purpose 调用 <see cref="Configuration.Ez2ConfigManager.ResolveForReplay"/>。</para>
    /// </summary>
    public interface IEzReplaySession
    {
        ...
        /// </summary>
        Task<Score> RunAsync(Score score, IBeatmap beatmap, IGameplayEnvironment? environment = null, ReplayRunPurpose purpose = ReplayRunPurpose.ForStored,
                             CancellationToken cancellationToken = default);

        /// <summary>
        /// 运行 replay 判定并构建时间线（用于角逐 ghost）。
        /// </summary>
        Task<EzScoreTimeline> RunTimelineAsync(Score score, IBeatmap beatmap, IGameplayEnvironment? environment = null,
        ...
        /// </summary>
        Task<EzScoreTimeline> RunTimelineDirectAsync(Score score, IBeatmap beatmap, IGameplayEnvironment? environment = null,
